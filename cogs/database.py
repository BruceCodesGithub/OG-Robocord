...
class Database(commands.Cog):
    ...
    async def create_db(self):
        await self.bot.con.execute("CREATE TABLE IF NOT EXISTS Tags (name TEXT,content TEXT ,author BIGINT ,aliases TEXT[])")
    ...
    async def new(self,n,v,i):
        ...
        if exists:
            ...
            await self.bot.con.execute("INSERT INTO Tags (name,content,author) VALUES($1,$2,$3)",n,v,i)
    ...
    async def update(self,n,c,auth):
        ...
        if not e:
            ...
            if authcheck[0] == auth:
                a = e[0]  
                await self.bot.con.execute("UPDATE Tags SET content=$1 WHERE name=$2",c,n)
    ...
    async def set_aliases(self,n,a,auth):
        ...
        if not e:
            ...
            e = e[0]
            await self.bot.con.execute('INSERT INTO Tags (name,content,author) VALUES($1,$2,$3)',a,e,auth)
            return "SUCCESS"
