...
class Database(commands.Cog):
    ...
    async def create_db(self):
        await self.bot.con.execute("CREATE TABLE IF NOT EXISTS Tags (id BIGINT, name TEXT,content TEXT ,author BIGINT ,aliases TEXT[])")
    ...
    async def new(self,n,v,i):
        ...
        if exists:
            ...
            a = int(a[0])
            await self.bot.con.execute("INSERT INTO Tags (id,name,content,author,aliases) VALUES($1,$2,$3,$4,$5)",a+1,n,v,i,[])
